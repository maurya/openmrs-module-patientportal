...
public class PatientPortalSharingToken extends BaseOpenmrsMetadata implements Comparable<PatientPortalSharingToken> {
     ...
     */
    @Override
    public int compareTo(final PatientPortalSharingToken newToken) {
