 ...
 *   @author maurya
 */
public class PatientPortalLogEvent {
    private Integer id;
     ...
     */
    public PatientPortalLogEvent(String eventType, Date eventDate, Integer userId, String sessionId, Integer patientId, String eventContent) {
