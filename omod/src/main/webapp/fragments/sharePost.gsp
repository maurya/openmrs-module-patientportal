...
<link rel="stylesheet"
	href="${ ui.resourceLink("patientportal", "styles/sharePostStyles.css") }"
	type="text/css">
<script type="text/javascript"
	src="/openmrs/ms/uiframework/resource/patientportal/scripts/bootstrap.min.js"></script>
<%
...
<div class="journal-share">
	<div class="journal-share-header">
		<p>
			<i class="icon-share-alt"></i> share with <select>
	...
	<div class="journal-share-content">
		...
		<textarea class='share-text-area animated'
			placeholder="How are you feeling today?"></textarea>
	</div>
	<div class="journal-share-footer">
		<p>
			Feeling <i class=" icon-camera"></i> <a class="post-button">post</a>
			<a>clear</a>
